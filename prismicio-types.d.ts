...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Scond Heading field in *Hero → Default → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.scond_heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  scond_heading: prismic.TitleField;

  /**
   * Scond Body field in *Hero → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.scond_body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  scond_body: prismic.RichTextField;
}
